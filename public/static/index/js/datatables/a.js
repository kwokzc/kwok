...
// 判断前端是否有设置，如果没有则加载默认设置
if( typeof aasort == 'undefined' ) {
    // aasort 为undefined 时加载默认设置
...
(function(Ea, P, k) {
	var O = function(h) {
			...
			function jb(a) {
				...
				i && (d = h("<tr/>").appendTo(g));
				b = 0;
				for (c = l.length; b < c; b++) f = l[b], e = h(f.nTh).addClass(f.sClass), i && e.appendTo(d), a.oFeatures.bSort && (e.addClass(f.sSortingClass), !1 !== f.bSortable && (e.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a, f.nTh, b))), f.sTitle != e.html() && e.html(f.sTitle), Pa(a, "love.view.layout.header")(a, e, f, m);
				i && da(a.aoHeader, g);
			...
			function M(a) {
				...
				if (-1 !== h.inArray(!1, b)) C(a, !1);
					...
					w(a, "aoHeaderCallback", "love.view.layout.header", [h(a.nTHead).children("tr")[0], La(a), g, m, i]);
			...
			function Ta(a, b, c) {
				var e = a._iDisplayStart,
					d = a._iDisplayLength,
					f = a.fnRecordsDisplay();
				0 === f || -1 === d ? e = 0 : "number" === typeof b ? (e = b * d, e > f && (e = 0)) : "第一页" == b ? e = 0 : "上一页" == b ? (e = 0 <= d ? e - d : 0, 0 > e && (e = 0)) : "下一页" == b ? e + d < f && (e += d) : "最后一页" == b ? e = Math.floor((f - 1) / d) * d : R(a, 0, "Unknown paging action: " + b, 5);
			...
			var $a = function(a, b) {
				...
				Ca = function(a, b) {
					...
					else if ("timeline.view.index.index" == e || "original" == e) {
						c = 0;
			...
			o.defaults = {
				...
				// 默认显示长度 加载JS变量aadisplaylength，可在前端页面设置变量数值
				iDisplayLength: aadisplaylength,
			...
			h.extend(Mb, {
				...
				simple_numbers: function(a, b) {
					return ["上一页", Wa(a, b), "下一页"]
				},
				full_numbers: function(a, b) {
					return ["第一页", "上一页", Wa(a, b), "下一页", "最后一页"]
				},
				_numbers: Wa,
				numbers_length: 7
			});
